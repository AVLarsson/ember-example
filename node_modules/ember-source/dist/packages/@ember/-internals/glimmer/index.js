import { templateFactory, unwrapTemplate, PartialDefinition, EMPTY_BLOCKS, NONE, staticComponent, UNHANDLED, JitContext, unwrapHandle } from '@glimmer/opcode-compiler';
import { get, PROPERTY_DID_CHANGE, set, computed, alias, tagForObject, objectAt, tagForProperty, CUSTOM_TAG_FOR } from '@ember/-internals/metal';
import { getOwner, OWNER } from '@ember/-internals/owner';
import { setFrameworkClass, TargetActionSupport, FrameworkObject, _contentFor, isArray, Object as Object$1 } from '@ember/-internals/runtime';
import { symbol, guidFor, getDebugName, isObject, isProxy, HAS_NATIVE_SYMBOL, isEmberArray, HAS_NATIVE_PROXY, uuid, toString } from '@ember/-internals/utils';
...
import { UPDATE_REFERENCED_VALUE, ComponentRootReference, HelperRootReference, RootReference, IterationItemReference, PropertyReference, ConstReference } from '@glimmer/reference';
import { normalizeProperty, EMPTY_ARGS, PrimitiveReference, UNDEFINED_REFERENCE, dynamicAttribute, SimpleDynamicAttribute, NULL_REFERENCE, curry, getDynamicVar, clientBuilder, DOMChanges, DOMTreeConstruction, inTransaction, JitRuntimeFromProgram, renderJitMain, rehydrationBuilder } from '@glimmer/runtime';
export { DOMChanges, DOMTreeConstruction, isSerializationFirstNode } from '@glimmer/runtime';
import { createTag, dirty, CONSTANT_TAG, value, consume, deprecateMutationsInAutotrackingTransaction, combine, isConst, validate, createUpdatableTag, update, isTracking, track, untrack, isConstTag, CURRENT_TAG, runInAutotrackingTransaction } from '@glimmer/validator';
...
import { EMPTY_ARRAY, expect, Stack, dict } from '@glimmer/util';
  ...
  constructor(helper$$1, args, env) {
    let fnWrapper = args => {
      ...
      if (helper$$1[RECOMPUTE_TAG]) {
        consume(helper$$1[RECOMPUTE_TAG]);
      }
    ...
    if (DEBUG) {
      let debugName = isSimpleHelper(helper$$1) ? getDebugName(helper$$1.compute) : getDebugName(helper$$1);
...
class MutReference extends RootReference {
  ...
  [UPDATE_REFERENCED_VALUE](value$$1) {
    return this.inner[UPDATE_REFERENCED_VALUE](value$$1);
  }
